...
2. **必须采用【结构化子段落】来扩充旁白内容**：
   ...
   - **分镜2**：【新闻原文中的全套硬核数据与细节展开】 + 【结构与背景细节剖析】 + 【行业/供应链推演】
...
🎙️ **旁白口播**：[此处写满 350 字以上！必须把新闻原文中的所有细节数据、具体名称、统计数据一字不漏地展开，并逐一解释这些数据对行业、市场或全球经济的深远影响。]
🎥 **画面描述**：[匹配画面描述]
🎬 **即梦/剪映 Prompt**：[中文 Prompt]
⚙️ **ComfyUI Prompt**：[英文 Tag 组]

【分镜3 | 地缘博弈与连锁剧变】（预计时长：80秒 | 旁白要求：至少350字）
🎙️ **旁白口播**：[此处写满 350 字以上！深入复述新闻中的核心冲突背景与关键利益方，详细推演事件影响以及由此带来的成本暴涨、供应链受阻或格局改写等连锁剧烈影响。]
🎥 **画面描述**：[匹配画面描述]
🎬 **即梦/剪映 Prompt**：[中文 Prompt]
⚙️ **ComfyUI Prompt**：[英文 Tag 组]
